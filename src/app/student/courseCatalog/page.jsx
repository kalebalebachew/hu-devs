      ...
      <main className="container mx-auto px-4 py-8">
        <div className="mb-8">
          <form className="flex gap-4">
            ...
            />
            <Button type="submit" className="bg-black border border-purple-500 border-opacity-45">
          ...
          {courses.map((course) => (
            <Card key={course.id} className="bg-gray-800 border-gray-700">
              ...
              <CardContent>
                ...
                <p className="text-sm text-purple-400">Provider: {course.provider}</p>
                <p className="text-sm text-purple-400">Instructor: {course.instructor}</p>
              </CardContent>
              <CardFooter>
